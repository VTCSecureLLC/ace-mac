...
FOUNDATION_EXPORT NSString *const ENABLE_STUN;
...
FOUNDATION_EXPORT NSString *const OUTBOUND_PROXY_SERVER;
FOUNDATION_EXPORT NSString *const OUTBOUND_PROXY_CHECKBOX;
